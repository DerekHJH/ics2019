...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x68 */	IDEXW(I,push,4), IDEX(I_E2G,imul3), IDEXW(push_SI,push,1), EMPTY,
...
/*2 byte_opcode_table */
  ...
  /* 0xbc */	IDEX(mov_E2G,bsf), EMPTY, IDEXW(mov_E2G,movsx,1), IDEXW(mov_E2G,movsx,2),
